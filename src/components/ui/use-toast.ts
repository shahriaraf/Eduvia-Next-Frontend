...
/**
 * Fire a toast from anywhere (event handler, RTK Query mutation
 * onSuccess/onError, etc.) without needing a hook — used e.g. right
 * after create/update/delete API calls resolve.
 */
